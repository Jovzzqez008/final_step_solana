    ...
    while True:
        try:
            ...
            for pair in new_pairs:
                ...
                if age_hours > 8 and liquidity >= 8000 and holders >= 3:
                ...
                # REGLA 3: El Gran Filtro de 24 horas
                    ...
                    if dex_data:
                        ...
                        if holders < 111:
                            ...
                            # Si sobrevive, enviamos el reporte normal de 24h
...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE): await update.message.reply_text("👋 v12.1 (Filtro Progresivo). Usa /cazar, /parar, /status.")
async def hunt_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("🔭 ¡Iniciando el explorador con filtro progresivo!")

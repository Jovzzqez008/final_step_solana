            ...
            async with connect(HELIUS_RPC_URL) as websocket:
                ...
                async for msg in websocket:
                    for log_message in msg:
                        ...
                        ### --- INICIO DE LA MODIFICACIÓN (DIAGNÓSTICO PROFUNDO) --- ###
                        # Mostramos el log crudo para ver si estamos recibiendo datos
                        logger.info(f"[RAW LOG] Recibido: {logs}")
...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("👋 ¡Bienvenido al Bot Cazador PRO v5.6 (Diagnóstico Profundo)!\n\nUsa /cazar, /parar, /status, /diagnostico.")

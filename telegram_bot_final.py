...
async def procesar_nuevo_token(token_address, source, chat_id):
    # Lista mejorada de direcciones a ignorar (programas, tokens de utilidad, etc.)
    direcciones_a_ignorar = {
        ...
        '675kPX9MHTjS2zt1qfr1NYHuzeLXfQM9H24wFSUt1Mp8',  # Raydium LP v4 (el que vigilamos)
    ...
    if es_seguro:
        ...
        logger.info(f"  - ❌ [RECHAZADO SEGURIDAD] No pasó el filtro de seguridad. Razón: {reporte_seguridad}")
### --- FIN DE LA MODIFICACIÓN --- ###


# ... (El resto del código, incluyendo incubator_checker_task, raydium_hunter_task, etc., no cambia) ...
...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("👋 ¡Bienvenido al Bot Cazador PRO v5.9 (Filtro de Ruido)!\n\nUsa /cazar, /parar, /status, /diagnostico.")

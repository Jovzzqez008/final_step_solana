    ...
    while True:
        try:
            ...
            for pair in new_pairs:
                ...
                # Criterios ajustados: 1h <= edad <= 24h, >$8k liquidez, >3 holders
...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE): await update.message.reply_text("👋 v12.3 (Rango de Oportunidad). Usa /cazar, /parar, /status.")
...
async def hunt_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("🔭 ¡Iniciando el explorador con 'Rango de Oportunidad' (1-24h)!")

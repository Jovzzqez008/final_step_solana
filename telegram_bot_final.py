...
current_mode = "estricto" # Modo por defecto
...
async def search_for_opportunities(client, mode):
    """Busca en DexScreener con filtros dinámicos según el modo."""
    if mode == "estricto":
    ...
    while True:
        try:
            ...
            for pair in pairs:
                ...
                # --- FILTRO DE SEGURIDAD (APLICA A AMBOS MODOS) ---
                ...
                # Ajustamos el filtro de holder según el modo
                top_holder_pct = rugcheck_data.get('topHolders', [{}])[0].get('pct', 1) * 100
                holder_limit = 40 if current_mode == "estricto" else 90 # Más permisivo en modo flexible
...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("👋 v14.0 (Modos Flexibles). Usa /cazar, /parar, /status, /modo_estricto, /modo_flexible.")

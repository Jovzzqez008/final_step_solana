    ...
    while True:
        try:
            ...
            for token_address, data in list(incubator.items()):
                # ÚNICO FILTRO: Chequeo de Mercado con DexScreener
...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE): await update.message.reply_text("👋 v11.0 (Autónomo). Usa /cazar, /parar, /status.")
async def hunt_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("🏹 ¡Iniciando caza con análisis de mercado autónomo!")
